...
## 2024-06-03 - [Missing Focus Styles on .btn-glow]
...
**Action:** Always provide custom focus styles using `focus-visible:` pseudo-classes (like `focus-visible:ring-2` and `focus-visible:ring-[#E5BE85]/50`) instead of `focus:` when using custom button classes like `.btn-glow` to ensure visual focus rings are only shown for keyboard navigation and not upon mouse clicks.
